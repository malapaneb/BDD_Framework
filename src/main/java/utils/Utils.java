...
public class Utils extends clsConstants{
...
//            options.internetExplorer().setCapability("ignoreProtectedModeSettings", true);
...
public  void  writeToTxtFile(String fileName,String text)
    {
        try {
            String outputFile = "src/test/outputFiles/"+fileName;
    ...
    public static String readtxtFile(String fileName) throws Exception
    {
        ...
        File file = new File("src/test/outputFiles/"+fileName);
